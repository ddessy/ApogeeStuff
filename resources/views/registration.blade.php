        ...
        <div class="panel panel-info" style="border-color: rgb(63, 81, 181);">
            ...
            <div style="padding-top:30px" class="panel-body">
                ...
                <form id="registrationform" class="form-horizontal" role="form"
                      action="{{ route('home.doRegistration') }}" onsubmit="return validateForm();" method="POST">
                    @csrf
                    ...
                    <div style="margin-bottom: 25px" class="inputs">
                        <input id="reg-password-r" type="password" class="form-control" name="password_r"
                    ...
                    <div class="form-group">
                        <div class="col-md-12 control">
                            <div style="border-top: 1px solid#888; padding-top:15px;">
                                ...
                                <a href="{{ route('home.showLogin') }}">Вход</a>
                            </div>
                        </div>
                    </div>
                </form>
