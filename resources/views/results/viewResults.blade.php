    ...
    <div style="margin-top:50px;" class="mainbox col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info" style="border-color: rgb(63, 81, 181);">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('results.gameResults') }}" method="GET">
...
@section('AdditionalCss')
    ...
    <link href="{{ asset('/css/pages/results/viewResults.css') }}" rel="stylesheet">
@endsection
...
@section('AdditionalJs')
    ...
    <script src="{{ asset('/js/pages/results/viewResults.js') }}"></script>
@endsection
